...
export const routeTable: RouteEntry[] = [
  ...
  { key: 'ADMIN_BRANDS', path: ROUTES.ADMIN_BRANDS, page: 'AdminBrandsPage', importPath: './pages/admin/AdminBrandsPage', label: 'Brands', gate: 'admin', nav: true },
  { key: 'ADMIN_CATEGORIES', path: ROUTES.ADMIN_CATEGORIES, page: 'AdminCategoriesPage', importPath: './pages/admin/AdminCategoriesPage', label: 'Categories', gate: 'admin', nav: true },
