      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center">
            <img
              src="/Prakash_store_aundh.png"
              alt="Prakash Stores storefront in Aundh, Pune"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="flex justify-center order-2 md:order-1">
            <img
              src="/Prakash_Store_aundh_2.png"
              alt="Inside the Prakash Stores showroom in Aundh, Pune"
              className="rounded-lg shadow-lg max-h-[400px] object-cover"
            />
          </div>
